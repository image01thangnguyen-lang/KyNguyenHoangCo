...
export function renderCampTerritory(profile: ProfileSave, handlers: Handlers): void {
...
export function renderBagPanel(profile: ProfileSave, handlers: Handlers): void {
  ...
  const btnUpgradeSpeed = document.getElementById('btn-bag-upgrade-speed') as HTMLButtonElement | null;
  if (btnUpgradeSpeed) {
    if (isSafeTab) {
