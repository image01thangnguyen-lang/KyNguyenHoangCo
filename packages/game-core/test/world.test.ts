...
import { POI } from '../src/balance.ts';
import {
  buildPackIndex,
  cellAt,
  cellById,
...
import { forecast, modifiersOf, rainHarvest, regionOf, weatherFor } from '../src/weather.ts';
import { createClockState, readClock } from '../src/clock.ts';
import { checkSpeed, createSpeedState } from '../src/safety.ts';
