 ...
 */
export const SPEED_UPGRADE_COSTS: Record<number, { coin: number; resourceItem?: string; resourceQty?: number; resourceNameVi?: string }> = {
 ...
 */
export function calcMovementSpeedKmh(player: PlayerState): number {
 ...
 */
export function upgradeSpeed(player: PlayerState): { player: PlayerState; success: boolean; messageVi: string } {
