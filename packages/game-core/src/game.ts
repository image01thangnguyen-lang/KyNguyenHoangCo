...
export function withdrawFromSafe(profile: ProfileSave, moves: ItemStack[]): ActionResultBase {
...
export function upgradeSafeVaultRank(profile: ProfileSave): ActionResultBase {
