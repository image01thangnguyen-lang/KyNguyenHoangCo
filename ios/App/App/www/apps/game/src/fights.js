...
import { BLOOD_MOON, getItem } from '../../../packages/game-core/src/index.js';
                                                                                                                    
import { el } from './panels.js';
import { timingRound } from './minigames.js';
...
export function openNightDefense(view          , handlers                      )       {
  show();
  const host = card();
...
export function openBloodMoon(profile             , handlers                   )       {
  show();
  const host = card();
  ...
  let chosen               = BLOOD_MOON.defaultDifficulty                ;
...
function renderFight(
  ...
  const fill = host.querySelector             ('.fight__bar > div') ;
  const hpText = host.querySelector             ('.js-hp') ;
  const shareText = host.querySelector             ('.js-share') ;
  const logBox = host.querySelector             ('.fight__log') ;
