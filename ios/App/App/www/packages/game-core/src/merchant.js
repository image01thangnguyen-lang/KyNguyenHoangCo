...
export const ITEM_SELL_PRICES                         = {
  ...
  // Nguyên liệu khoáng sản & Thu thập đã sơ chế
  gold_ore: 4,
  iron_ore: 2,
  iron_ingot: 4,
  coal: 1,
