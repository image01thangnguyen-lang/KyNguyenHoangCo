...
export const TERRAIN_SURFACE_REGISTRY                                         = {
...
export function getTerrainSurfaceDef(type             )                    {
...
export const WEIGHT_CATEGORY_DEFS                                                  = {
...
export class ObjectPool                      {
  ...
  constructor(factory         , initialCapacity        ) {
...
export class Footprint                      {
  ...
  maxDurationSec = 8.0;
  isLeftFoot = false;
  entityWeightCategory                       = EntityWeightCategory.MEDIUM;
...
export class DinoBiomeMap {
           ...
           cellSizeMeters        ;
           cells               ;
           oasisPoiPosition                                  = null;
           canopyTrees                                                                        = [];
           stealthZones                                                              = [];

  constructor(biome         , width = 64, height = 64, cellSizeMeters = 2.0, seed = 42) {
    this.biome = biome;
    this.width = width;
    this.height = height;
  ...
  getTerrainSpeedModifier(worldX        , worldY        )         {
  ...
  // --------------------------------------------------------------------------
          generateTriassicRedDesert(noise                 )                           {
    let minElevation = 1.0;
    let minElevCell                           = { x: Math.floor(this.width / 2), y: Math.floor(this.height / 2) };
  ...
  // --------------------------------------------------------------------------
          generateJurassicEmeraldJungle(noise                 )       {
...
export class TopDownVisionManager {
   ...
   */
  updateCanopyFade(playerWorldX        , playerWorldY        , dtSec        )       {
   ...
   */
  checkEntityStealth(entityId        , worldX        , worldY        )                     {
