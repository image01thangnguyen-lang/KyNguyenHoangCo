...
import { createCoopRoom, joinCoopRoom, startCoopBattle, processCoopRound, resolveCoopRewards } from '../src/coop.js';
                                                   

function createMockProfile(name        , campDef = 50, weaponId      = 'stone_spear')              {
  return {
    id: `profile_${name}`,
    name,
    createdAt: Date.now(),
