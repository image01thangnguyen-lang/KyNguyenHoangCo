...
import { addItems, countOf } from './inventory.js';

export function createPlayerBeastState()                   {
  return {
    discoveredClues: 0,
    raidedDenIds: [],
...
export const HANOI_BEAST_TERRITORIES                   = [
  {
...
export function checkNightAmbientThreat(
  ...
  let currentSafeHaven                     = undefined;
