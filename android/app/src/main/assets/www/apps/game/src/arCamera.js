 ...
 */
export function setARModel(model                                                               )       {
...
function drawARSaberCub(ctx                          , s        , t        )       {
...
function drawARMammoth(ctx                          , s        , t        )       {
...
function drawARBossShadow(ctx                          , s        , t        )       {
...
function drawARWatermark(ctx                          , w        , h        , locationName        )       {
  ctx.save();
