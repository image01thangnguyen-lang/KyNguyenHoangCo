...
function svg(content        , className = 'item-svg')         {
...
export function coinIconSvg(size = 16)         {
...
export function itemIconSvg(id        , className = 'item-svg')         {
  switch (id) {
...
export function zoneIconSvg(zone        , className = 'zone-svg')         {
  switch (zone) {
    case 'forest':
      return svg(
...
export function actionIconSvg(actionId        , className = 'action-svg')         {
  switch (actionId) {
    case 'chop_wood':
      return svg(
...
export function avatarSvg(gender                   , className = 'avatar-svg')         {
  if (gender === 'female') {
    return svg(
      `<!-- Nữ Thổ Dân Tiền Sử -->
